...
import './TeacherUpdateProfile.css'
...
const TeacherUpdateProfile = () => {
    ...
    return (
        <div className='setBackground'>
            ...
            <div className='formhandle teacherupdateprofile' >

        
            <form className='ship-form updateprofile teacherupdateprofile' onSubmit={handleSubmit(onSubmit)}>
